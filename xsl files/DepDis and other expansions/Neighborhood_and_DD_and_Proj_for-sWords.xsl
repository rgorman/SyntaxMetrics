                                ...
                                <word>
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="$head_2 = 0">
                                            <DD-rel-pos-sWord-2><xsl:attribute name="ref"><xsl:value-of select="./@cite"/></xsl:attribute>#-<xsl:value-of
                                                select="
                                                normalize-space(string-join((
                                                parent::sentence/word[@id = $head_1]/@DepDist,
                                                parent::sentence/word[@id = $head_1]/@relation,
                                        ...
                                        <xsl:when test="$head_2 > 0">
                                            <DD-rel-pos-sWord-2><xsl:attribute name="ref"><xsl:value-of select="./@cite"/></xsl:attribute>
                                                <xsl:value-of
                                                    select="
                                                    normalize-space(string-join((
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="$head_3 = 0">
                                            <DD-rel-pos-sWord-3><xsl:attribute name="ref"><xsl:value-of select="./@cite"/></xsl:attribute>#-<xsl:value-of
                                                select="
                                                normalize-space(string-join((
                                                parent::sentence/word[@id = $head_2]/@DepDist,
                                                parent::sentence/word[@id = $head_2]/@relation,
                                        ...
                                        <xsl:when test="$head_3 > 0">
                                            <DD-rel-pos-sWord-3><xsl:attribute name="ref"><xsl:value-of select="./@cite"/></xsl:attribute>
                                                <xsl:value-of
                                                    select="
                                                    normalize-space(string-join((
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="$head_4 = 0">
                                            <DD-rel-pos-sWord-4><xsl:attribute name="ref"><xsl:value-of select="./@cite"/></xsl:attribute>#-<xsl:value-of
                                                select="
                                                normalize-space(string-join((
                                                parent::sentence/word[@id = $head_3]/@DepDist,
                                                parent::sentence/word[@id = $head_3]/@relation,
                                        ...
                                        <xsl:when test="$head_4 > 0">
                                            <DD-rel-pos-sWord-4><xsl:attribute name="ref"><xsl:value-of select="./@cite"/></xsl:attribute>
                                                <xsl:value-of
                                                    select="
                                                    normalize-space(string-join((
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="$head_5 = 0">
                                            <DD-rel-pos-sWord-5><xsl:attribute name="ref"><xsl:value-of select="./@cite"/></xsl:attribute>#-<xsl:value-of
                                                select="
                                                normalize-space(string-join((
                                                parent::sentence/word[@id = $head_4]/@SepDist,
                                                parent::sentence/word[@id = $head_4]/@relation,
                                                substring(parent::sentence/word[@id = $head_4]/@postag, 1, 1),
                                                parent::sentence/word[@id = $head_3]/@DepDist,
                                                parent::sentence/word[@id = $head_3]/@relation,
                                        ...
                                        <xsl:when test="$head_5 > 0">
                                            <DD-rel-pos-sWord-5><xsl:attribute name="ref"><xsl:value-of select="./@cite"/></xsl:attribute>
                                                <xsl:value-of
                                                    select="
                                                    normalize-space(string-join((
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="$head_6 = 0">
                                            <DD-rel-pos-sWord-6><xsl:attribute name="ref"><xsl:value-of select="./@cite"/></xsl:attribute>#-<xsl:value-of
                                                select="
                                                normalize-space(string-join((
                                                parent::sentence/word[@id = $head_5]/@DepDist,
                                                parent::sentence/word[@id = $head_5]/@relation,
                                        ...
                                        <xsl:when test="$head_6 > 0">
                                            <DD-rel-pos-sWord-6><xsl:attribute name="ref"><xsl:value-of select="./@cite"/></xsl:attribute>
                                                <xsl:value-of
                                                    select="
                                                    normalize-space(string-join((
...
<!-- End of code block adding Dep Dtst to rel-pos sWords.  Only sWord levels 0-6 are included. Higher sWords are probably too rare to be
     worth condiering.  --> 
                                    ...
                                    <DD-rel-sWord-1><xsl:attribute name="ref"><xsl:value-of select="./@cite"/></xsl:attribute>
                                        <xsl:choose>
                                            <xsl:when test="$head_1 = 0">#-<xsl:value-of
                                                select="string-join((
                                                ./@DepDist,
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="$head_2 = 0">
                                            <DD-rel-sWord-2><xsl:attribute name="ref"><xsl:value-of select="./@cite"/></xsl:attribute>#-<xsl:value-of
                                                select="
                                                string-join((
                                                parent::sentence/word[@id = $head_1]/@DepDist,
                                                parent::sentence/word[@id = $head_1]/@relation,
                                        ...
                                        <xsl:when test="$head_2 > 0">
                                            <DD-rel-sWord-2><xsl:attribute name="ref"><xsl:value-of select="./@cite"/></xsl:attribute>
                                                <xsl:value-of
                                                    select="
                                                    string-join((
                                                    parent::sentence/word[@id = $head_2]/@DepDist,
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="$head_3 = 0">
                                            <DD-rel-sWord-3><xsl:attribute name="ref"><xsl:value-of select="./@cite"/></xsl:attribute>#-<xsl:value-of
                                                select="
                                                string-join((
                                                parent::sentence/word[@id = $head_2]/@DepDist,
                                                parent::sentence/word[@id = $head_2]/@relation,
                                        ...
                                        <xsl:when test="$head_3 > 0">
                                            <DD-rel-sWord-3><xsl:attribute name="ref"><xsl:value-of select="./@cite"/></xsl:attribute>
                                                <xsl:value-of
                                                    select="
                                                    string-join((
                                                    parent::sentence/word[@id = $head_3]/@DepDist,
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="$head_4 = 0">
                                            <DD-rel-sWord-4><xsl:attribute name="ref"><xsl:value-of select="./@cite"/></xsl:attribute>#-<xsl:value-of
                                                select="
                                                string-join((
                                                parent::sentence/word[@id = $head_3]/@DepDist,
                                                parent::sentence/word[@id = $head_3]/@relation,
                                        ...
                                        <xsl:when test="$head_4 > 0">
                                            <DD-rel-sWord-4><xsl:attribute name="ref"><xsl:value-of select="./@cite"/></xsl:attribute>
                                                <xsl:value-of
                                                    select="
                                                    string-join((
                                                    parent::sentence/word[@id = $head_4]/@DepDist,
...
<!-- End of code block bputting DD in pos sWords -->
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="$head_2 = 0">
                                            <Neighborhood-rel-pos-sWord-2><xsl:attribute name="ref"><xsl:value-of select="./@cite"/></xsl:attribute>#-<xsl:value-of
                                                select="
                                                normalize-space(string-join((
                                                parent::sentence/word[@id = $head_1]/@Rel_Pos_Subtree,
                                                ./@Rel_Pos_Subtree
                                        ...
                                        <xsl:when test="$head_2 > 0">
                                            <Neighborhood-rel-pos-sWord-2><xsl:attribute name="ref"><xsl:value-of select="./@cite"/></xsl:attribute>
                                                <xsl:value-of
                                                    select="
                                                    normalize-space(string-join((
...
<!-- End of code block extracting rel-pos neighborhood subtrees. -->
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="$head_2 = 0">
                                            <Neighborhood-rel-sWord-2><xsl:attribute name="ref"><xsl:value-of select="./@cite"/></xsl:attribute>#-<xsl:value-of
                                                select="
                                                normalize-space(string-join((
                                                parent::sentence/word[@id = $head_1]/@Relation_Subtree,
                                                ./@Relation_Subtree
                                        ...
                                        <xsl:when test="$head_2 > 0">
                                            <Neighborhood-rel-sWord-2><xsl:attribute name="ref"><xsl:value-of select="./@cite"/></xsl:attribute>
                                                <xsl:value-of
                                                    select="
                                                    normalize-space(string-join((
 ...
 <!-- End of code block for rel-pos neighborhood subtrees. -->
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="$head_2 = 0">
                                            <Neighborhood-pos-sWord-2><xsl:attribute name="ref"><xsl:value-of select="./@cite"/></xsl:attribute>#-<xsl:value-of
                                                select="
                                                normalize-space(string-join((
                                                parent::sentence/word[@id = $head_1]/@POS_Subtree,
                                                ./@POS_Subtree
                                        ...
                                        <xsl:when test="$head_2 > 0">
                                            <Neighborhood-pos-sWord-2><xsl:attribute name="ref"><xsl:value-of select="./@cite"/></xsl:attribute>
                                                <xsl:value-of
                                                    select="
                                                    normalize-space(string-join((
 ...
 <!-- End of code block for pos neighborhood subtrees. -->
                                    ...
                                    <!-- Block of code adding projectivity status to sWords. Only sWord levels 0-6 are processed. -->
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="$head_2 = 0">
                                            <project-rel-pos-sWord-2><xsl:attribute name="ref"><xsl:value-of select="./@cite"/></xsl:attribute>#-<xsl:value-of
                                                select="
                                                normalize-space(string-join((
                                                parent::sentence/word[@id = $head_1]/@Projectivity,
                                                parent::sentence/word[@id = $head_1]/@relation,
                                        ...
                                        <xsl:when test="$head_2 > 0">
                                            <project-rel-pos-sWord-2><xsl:attribute name="ref"><xsl:value-of select="./@cite"/></xsl:attribute>
                                                <xsl:value-of
                                                    select="
                                                    normalize-space(string-join((
                                        ...
                                        <xsl:when test="$head_5 > 0">
                                            <rel-pos-sWord-5><xsl:attribute name="ref"><xsl:value-of select="./@cite"/></xsl:attribute>
                                                <xsl:value-of
                                                    select="
                                                    normalize-space(string-join((
                                                    parent::sentence/word[@id = $head_5]/@Projectivity,
                                                    parent::sentence/word[@id = $head_5]/@relation,
                                                    substring(parent::sentence/word[@id = $head_5]/@postag, 1, 1),
                                                    parent::sentence/word[@id = $head_4]/@Projectivity,
                                                    parent::sentence/word[@id = $head_4]/@relation,
                                        ...
                                        <xsl:when test="$head_6 > 0">
                                            <rel-pos-sWord-6><xsl:attribute name="ref"><xsl:value-of select="./@cite"/></xsl:attribute>
                                                <xsl:value-of
                                                    select="
                                                    normalize-space(string-join((
                                                    parent::sentence/word[@id = $head_6]/@Projectivity,
                                                    parent::sentence/word[@id = $head_6]/@relation,
                                                    substring(parent::sentence/word[@id = $head_6]/@postag, 1, 1),
                                                    parent::sentence/word[@id = $head_5]/@Projectivity,
                                                    parent::sentence/word[@id = $head_5]/@relation,
